...
description: 瞭解如何將資料科學的深入分析內嵌至 [!DNL Experience Platform] 以擴充即時客戶設定檔。
...
個人檔案擴充藍圖的自訂資料科學說明了如何使用資料來訓練、部署和評分模型，以提供機器學習深入分析 [!DNL Experience Platform] 和 [!DNL Real-Time Customer Data Platform] 來自資料科學和機器學習工具。

模型化見解可內嵌至 [!DNL Experience Platform] 以豐富即時客戶設定檔。 機器學習深入見解的範例包括期限值評分、產品和類別親和性、轉換傾向性或退訂傾向性。
...
* 取得詳細的護欄，以及擷取資料科學結果的端對端延遲 [!DNL Experience Platform] 而即時客戶設定檔參考中參考的資料擷取護欄和延遲圖表。 [部署護欄檔案](../experience-platform/deployment/guardrails.md).
...
* 用於從擷取資料 [!DNL Experience Platform] 可以使用以下方法
   * 資料存取 SDK
      * 資料為原始檔案形式
...
* [Adobe資料分析的探索性介紹 [!DNL Experience Platform]](https://medium.com/adobetech/an-introductory-look-at-exploratory-data-analysis-on-adobe-experience-platform-1bfce7501d9a)
...
* [Segmentation.AI：Adobe中的自動化受眾叢集即服務 [!DNL Experience Platform]](https://medium.com/adobetech/segmentation-ai-automated-audience-clustering-as-a-service-in-adobe-experience-platform-261f4099462c)