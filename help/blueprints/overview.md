...
<tr>
  <td>
    ...
    <div><a href="https://experienceleague.adobe.com/docs/blueprints-learn/architecture/customer-journeys/journey-optimizer.html?lang=zh-Hant"><strong>跨通道協調</strong></a></div>
    <p><em>使用[!UICONTROL Platform]作為中心，即時傳送訊息並影響客戶體驗。</em></p>
  </td>
  <td>
    <a href="/help/blueprints/audience-activation/known.md"><img alt="已知客戶啟動藍圖的縮圖影像" src="audience-activation/assets/known_activation.svg" /></a>
