---
title: Adobe Experience Platform與應用程式
...
![Experience Platform和應用程式](assets/aep_apps_overview.png){width="1000" zoomable="yes"}

## 詳細的架構圖

![Experience Platform和應用程式](assets/aep_apps_detailed.png){width="1000" zoomable="yes"}