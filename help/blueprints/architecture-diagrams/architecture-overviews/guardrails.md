---
title: Adobe Experience Platform與應用程式護欄
...
ht-degree: 11%
---
# Adobe Experience Platform與應用程式護欄
...
* [Real-Time CDP護欄概觀](https://experienceleague.adobe.com/docs/experience-platform/rtcdp/guardrails/overview.html?lang=zh-Hant)
* [Customer Journey Analytics受眾共用護欄](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html?lang=zh-Hant#latency)
...
![Experience Platform [!DNL Edge Network]和中心主要觀察延遲。](/help/blueprints/architecture-diagrams/architecture-overviews/assets/aep_edge_hub_latency.png "Experience Platform Edge Network與中心主要觀察延遲"){width="1000" zoomable="yes"}