...
![B2B帳戶啟用Blueprint的參考架構](assets/b2b-account-activation.png){width="1000" zoomable="yes"}
...
- [B2B Audience和Profile Activation藍圖](b2b-audience-profile-activation.md) — 涵蓋人員層級和帳戶層級B2B啟用的父級Blueprint。
