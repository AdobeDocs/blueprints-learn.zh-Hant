---
title: Journey Optimizer 搭配 Adobe Campaign v8
...
ht-degree: 55%
---
# Journey Optimizer 搭配 Adobe Campaign v8

在[!DNL Campaign]中利用Real-time Messaging Server，示範Adobe [!DNL Journey Optimizer]如何與Adobe [!DNL Campaign]搭配使用，以原生方式傳送訊息。

## 架構

![參考架構Journey Optimizer](images/campaign-v8-with-ajo.png){width="1000" zoomable="yes"}
