---
title: AI助理與內容個人化
description: 使用Adobe Journey Optimizer的AI Assistant產生品牌內主旨列、調整電子郵件副本和色調，並在電子郵件設計工具中建立Firefly產生的影像。
doc-type: article
...
![新增AI產生的描述文字後以電子郵件預覽](assets/ai-assistant-and-content-personalization-email-with-description-text.png)
...
![Firefly影像設定，包括比例、內容型別和光線，然後產生](assets/ai-assistant-and-content-personalization-firefly-image-settings.png)
...
![具有圓形影像轉角的最終電子郵件區塊設計](assets/ai-assistant-and-content-personalization-final-block-design.png)
