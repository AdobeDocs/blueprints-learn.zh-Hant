...
2. 如果您尚未停止工作流程，請按一下右上方的&#x200B;**停止**&#x200B;按鈕。

   工作流程右上角的![停止按鈕](assets/run-the-workflow-click-stop-button.png)

   >[!NOTE]
   >
   >或者嘗試按一下「重新啟動」按鈕，但您可能會看到錯誤，因為您在工作流程建立後新增了活動，而且其快取不再有效。



3. 接著，按一下&#x200B;**開始**&#x200B;按鈕，以端對端執行及測試工作流程
...
5. 您看到&#x200B;**33筆記錄**，且目標維度符合客戶ID （設定檔的聯結索引鍵）
...
>[!SUCCESS]
>
>恭喜！ 您現在已獲得正式認證，可負責地推出自己的協調行銷活動，並向全世界廣播訊息。 現在您可以放心進行行銷！
...
1. 儲存對象活動會在對象入口網站中建立對象殼層，而合格的設定檔會開始內嵌
