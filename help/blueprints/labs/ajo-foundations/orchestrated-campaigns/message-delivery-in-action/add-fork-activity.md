...
在接下來的幾組步驟中，您將新增「分支」活動至促銷活動，並建立資料的相同分支。

## 分支活動

顯示具有已設定的&#x200B;**組建對象**&#x200B;的畫布。 按一下流程結尾的&#x200B;**+**，並從流程控制區段中新增&#x200B;**Fork**&#x200B;活動

![將Fork流量控制活動新增至畫布](assets/add-fork-activity-add-fork-flow-control.png)
