...
在此步驟中，您會匯入API集合，其中包含您在整個Bootcamp中需要提出的所有各種請求。  這些API要求取決於您剛匯入的環境檔案。
...
您匯入的集合包含您在整個bootcamp中用於Labs的所有API呼叫。  每個實驗室都會整理到特定的資料夾中，其中包含自己的請求集。
