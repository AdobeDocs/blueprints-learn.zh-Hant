...
>[!NOTE]
>
>如果您已經有具有Adobe Experience Platform認證的Developer Console專案（如有需要，還有Adobe Journey Optimizer），請略過本節，直接移至[部署指示](deployment-instructions.md)。
...
1. 提供認證名稱，並選取&#x200B;**下一步**
1. 選取與您將使用的沙箱相符的產品設定檔，然後選取「**儲存已設定的API**」

## 收集您的值

開啟認證的&#x200B;**OAuth伺服器對伺服器**&#x200B;總覽頁面。 CLI的環境檔案需要四個值：
