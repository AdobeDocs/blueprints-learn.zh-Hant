...
用於安裝案頭應用程式或使用Web版本的![Postman下載頁面](assets/postman-installation-download-page.png)
...
![Postman介面醒目提示側欄、頁首、主要工作區和頁尾](assets/postman-installation-interface-overview.png "Postman介面")
