...
使用[跨管道歷程與決策](/help/blueprints/use-case-patterns/campaign-management-orchestration/cross-channel-journey-with-decisioning.md)模式來協調個人化忠誠度通訊，強調相關獎勵、通知訂閱者層級進度，並根據其偏好和行為呈現贖回機會。 當歷程必須協調跨管道的傳遞以防止重複的忠誠度優惠方案，以及當優惠方案選擇需要層級狀態和贖回歷程記錄時，這是正確的模式 — 僅多步驟協調不會提供所需的即時決策層。
