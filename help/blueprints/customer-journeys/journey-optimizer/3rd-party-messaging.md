...
>[!TIP]
>此Blueprint也可作為「行銷活動管理與協調」下的[使用案例模式](/help/blueprints/use-case-patterns/campaign-management-orchestration/third-party-messaging.md)。
...
[Journey Optimizer Guardrails產品連結](https://experienceleague.adobe.com/docs/journeys/using/starting-with-journeys/limitations.html)
...
1. [為個人資料啟用方案和資料集](https://experienceleague.adobe.com/zh-hant/docs/platform-learn/tutorials/profiles/bring-data-into-the-real-time-customer-profile)。
