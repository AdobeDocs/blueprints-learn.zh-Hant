...
# Journey Optimizer搭配Adobe Campaign v8 Blueprint

在[!DNL Journey Optimizer]中利用Real-time Messaging Server，示範Adobe [!DNL Campaign]如何與Adobe [!DNL Campaign]搭配使用，以原生方式傳送訊息。

## 架構

<img src="images/ajo-campaign-v8-architecture.svg" alt="Journey Optimizer 參考架構藍圖" style="width:100%; border:1px solid #4a4a4a" class="modal-image" />

>[!IMPORTANT]
>可以同時使用 Journey Optimizer 和 Campaign 來彼此獨立傳送訊息，但有一些技術考量需加以考慮。如果您想要遵循此路線，請與您的售前企業架構師合作，確保您瞭解支援實施所需的條件
...
* Adobe Managed Cloud Services必須裝載即時傳訊服務（即訊息中心）的執行例項
* 所有訊息編寫都是在 Campaign 實例本身內完成

## 護欄

* [Journey Optimizer護欄產品限制](https://experienceleague.adobe.com/zh-hant/docs/journey-optimizer/using/get-started/guardrails)
...
1. 設定您的[!DNL Experience Platform]資料來源，並決定應該快取哪些欄位
