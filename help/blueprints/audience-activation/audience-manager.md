...
>[!TIP]
>此Blueprint也可作為Personalization下的[使用案例模式](/help/blueprints/use-case-patterns/personalization/anonymous-visitor-web-personalization.md)。
...
匿名Audience Activation Blueprint的![參考架構](assets/anonymous_activation.png)
