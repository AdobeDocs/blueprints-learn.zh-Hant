---
title: 資料準備與擷取藍圖
description: 此藍圖顯示Adobe中用來擷取及準備資料的所有方法 [!DNL Experience Platform].
...
資料準備與擷取Blueprint涵蓋了可用來準備資料並將其擷取到Adobe中的所有方法 [!DNL Experience Platform].
...
下圖說明將資料擷取至Adobe的平均效能護欄和延遲 [!DNL Experience Platform].
...
| 資料準備的方法 | 說明 |
|------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 外部 ETL 工具([!DNL Snaplogic]、 [!DNL Mulesoft]、 [!DNL Informatica]等) | 在ETL工具中執行複雜的轉換並使用標準 [!DNL Experience Platform] [!UICONTROL 流程服務] API或來源聯結器來內嵌產生的資料。 |
...
| XDM Mapper 與資料準備功能 (串流與批次) | 在「 」期間將CSV或JSON格式的來源屬性對應到XDM屬性 [!DNL Experience Platform] 內嵌。<br>在資料擷取時計算其功能；即資料格式化、拆分、聯結等。<br>[文件](https://experienceleague.adobe.com/docs/experience-platform/data-prep/home.html?lang=zh-Hant) |

## 相關部落格貼文

* [在Adobe中善用外部資料平台 [!DNL Experience Platform] [!DNL Journey Orchestration]](https://medium.com/adobetech/leveraging-external-data-platforms-in-adobe-experience-platform-journey-orchestration-54fc6134fe17?source=your_stories_page)
...
* [Adobe中的查詢服務訣竅 [!DNL Experience Platform] （寫入查詢及儲存衍生的資料集）](https://medium.com/adobetech/query-service-tricks-in-adobe-experience-platform-writing-queries-and-storing-derived-datasets-eaee0d6d683e?source=your_stories_page)
* [正在探索Adobe [!DNL Experience Platform]的體驗資料模型，以更完全瞭解即時客戶個人檔案的強大功能](https://medium.com/adobetech/digging-into-adobe-experience-platforms-experience-data-model-to-more-fully-understand-the-power-3e109271e04f?source=your_stories_page)
* [Adobe資料分析的探索性介紹 [!DNL Experience Platform]](https://medium.com/adobetech/an-introductory-look-at-exploratory-data-analysis-on-adobe-experience-platform-1bfce7501d9a?source=your_stories_page)
* [在Adobe上大規模建立資料科學的XDM資料模型 [!DNL Experience Platform]](https://medium.com/adobetech/modeling-xdm-data-for-data-science-at-scale-on-adobe-experience-platform-222bb2a6dbf7?source=your_stories_page)
