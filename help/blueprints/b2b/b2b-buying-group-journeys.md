...
如需有關聯結器設定和對應到結構描述之必要欄位的詳細資訊，請參閱[Marketo Engage聯結器檔案](https://experienceleague.adobe.com/en/docs/experience-platform/sources/connectors/adobe-applications/marketo/marketo)。
