...
# Marketo Engage與Workfront整合藍圖概觀 {#overview}
...
有了 Workfront Fusion，行銷營運團隊基本上可以消除將行銷簡報轉譯為行銷活動時容易出現錯誤的手動步驟。 Workfront Fusion 提供 Workfront 與 Marketo Engage 之間的立即可用整合層，其為系統之間開發工作流程提供彈性和效率。 若要深入瞭解如何設定整合，以及可採取哪些動作自動化工作流程[這裡](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/marketo-modules.html?lang=zh-Hant){target="_blank"}。
...
* 將行銷活動結果從 Marketo Engage 分享至 Workfront，將行銷活動量度的存取權民主化
...
標準化行銷活動和URL的命名慣例，是Marketo Engage中準確方案管理的關鍵基礎，並有助於在整個行銷活動開發生命週期中推動更一致的程式。 如果您正在尋找協助解決此問題的工具，建議您從[Adobe Success Services](https://main--marketo-campaign-tools--dr-adobe.hlx.live/){target="_blank"}簽出一些免費的開放原始碼工具，這些工具可讓您建立建立建立和管理Marketo Engage行銷活動及其關聯URL的一致方法。

### 資源 {#resources}

* [適用於Marketo Engage的Workfront Fusion](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/marketo-modules.html?lang=zh-Hant){target="_blank"}

* [適用於Workfront的Workfront Fusion](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/workfront-modules.html?lang=zh-Hant){target="_blank"}
