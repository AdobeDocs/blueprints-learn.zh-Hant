...
>[!TIP]
>此Blueprint也可作為B2B啟用與行銷下的[使用案例模式](/help/blueprints/use-case-patterns/b2b/account-analytics.md)。
...
![Customer Journey Analytics架構，其B2B帳戶與機會資料已整合以供歷程分析使用](assets/CJA.png){zoomable="yes"}
