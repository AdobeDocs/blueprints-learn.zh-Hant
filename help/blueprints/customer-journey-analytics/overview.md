...
您可以在[這裡](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/cja-usecases.html?lang=zh-Hant)找到使用案例的完整清單，以及檔案。

## Customer Journey Analytics 架構

![架構圖](assets/CJA.png){zoomable="yes"}