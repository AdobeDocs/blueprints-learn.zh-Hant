...
5. **執行計畫步驟** — 描述模式執行流程的3-6個循序階段，以`>`分隔。 範例：「事件擷取>歷程登入>條件評估>訊息傳送>報告」。
...
- 基本功能表格（功能、狀態、需準備就緒的專案、Experience League參考）
- 支援功能表格（功能、狀態、重要原因、Experience League參考）
- 應用程式功能表格（每個應用程式一個，具有「功能」、「實作階段」、「說明」）
- 先決條件檢查清單
...
9. **基本功能** — 含資料行的表格：基本功能、狀態、需準備就緒的專案、Experience League參考。 狀態值：必要、已假設就位、不適用。

10. **支援功能** — 含欄的表格：支援功能、狀態、重要原因、Experience League參考。 狀態值：建議、已包含、不適用。

11. **應用程式功能** — 每個應用程式有一個資料表，資料行：功能、實作階段、說明。
